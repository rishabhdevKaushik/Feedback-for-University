...
const CategorySelect = ({
    ...
    return (
        <div ref={containerRef} className="relative mb-6">
            ...
            <div
                className={`px15 md:px15 flex h-12 w-full cursor-pointer items-center justify-between rounded-xl bg-grey-white2 px-6 focus:outline focus:outline-1 focus:outline-strong-blue ${error ? "outline-red" : "outline-transparent"}`}
            ...
            >
                {value ? (
                    ...
                    <span className="text-blue">Choose category</span>
                )}
                <img
                    src={arrowIcon}
            ...
            {error && (
                <p className="mt-1 text-sm text-red md:text-sm absolute">
                    Can't be empty
                </p>
            )}
            <div
